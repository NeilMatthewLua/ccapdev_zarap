<template>
  <div class="review-post">
      <div class="row valign-wrapper">
        <div class="post-header valign-wrapper col s11">
        ...
        <div class="col s1 valign-wrapper" v-if="!isOwn"><i 
            ...
            @click="toggleLike"
            class="material-icons right-align">thumb_up</i>
        </div>
        <div class="col s2 valign-wrapper" v-else>
            <a class="submit-btn green btn" @click="editReview()"><i class="material-icons review-icons">edit</i></a>
            <a class="submit-btn red btn" @click="deleteReview()"><i class="material-icons review-icons">delete</i></a>
        </div>
      </div>
    <p ref="data" class="post-desc">I had a date with hubby here. I enjoyed so much!! Mwah mwah, labyu hubby. It was more 
    than just a restaurant. It was an experience.
    </p>
    </div>
</template>
